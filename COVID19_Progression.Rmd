...
```{r cp2, echo=FALSE}
cp2 <- paste(
    "*Confirmed __active__ cases of COVID-19 for countries where the active infection rate has exceeded", 
    minToInclude, "cases/million.",
    "Data is only shown for the first", nDays, "calendar days since passing",
    startingPoint, "confirmed active case/million.",
    "Due to difficulties introduced by the current __low active infection rate__ outside Hubei province, data from China has been excluded from this plot, with the exception of Hubei.",
    "To hide a country, click on the country in the plot legend.",
    "Clicking again on the country in the legend will restore the data within the plot.",
