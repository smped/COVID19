...
confirmed %>% 
  ...
  pander(
    ...
    caption = paste(
      ...
      "Only NSW is __not reporting recovered patient numbers__, and these values are presented as empty cells.",
      "^+^The recovery rate has been calculated only using states for which recovered patient information has been released, i.e. excluding NSW cases.*"
    ),
