...
```{r, fig.width=10, fig.height=10, fig.cap="*Most impacted 25 countries when combining rankings across both total confirmed cases, and total confirmed cases/million. Only countries with a population greater than 5 million are shown.*"}
minPop <- 5e6
confirmed %>%
  group_by(Country) %>%
