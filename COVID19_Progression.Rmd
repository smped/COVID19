...
confirmed %>% 
  ...
  pander(
    ...
    caption = glue(
      ...
      States which have not reported any change since publication of overnight JHU data are shown in italics.
      Negative numbers in the change column indicate issues with the automated data sources, such as health.gov.au.
      On 25th March, the health.gov.au numbers for the NT are out of step with those reported directly by https://coronavirus.nt.gov.au/*"),
...
Any updates on testing numbers beyond the initial values were automatically updated using the above code which probes each state's official releases for the latest values.
