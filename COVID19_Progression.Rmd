...
## Regional Cumulative Infection Rates
...
```{r, fig.height=8, fig.width=10, fig.cap = "*Current regional cumulative infection rates. Lines are shown from the point that local cases exceed 1 confirmed case / million*"}
ggplotly(
  confirmed %>% 
    inner_join(wikiPops) %>%
