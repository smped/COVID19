...
**JHU Data on 23rd March is inaccurate and contains no internationally updated values. All numbers below are impacted, and any apparent plateauing of numbers on this date is due to this disruption in the supply of data.**
...
Data was primarily sourced from Johns Hopkins University (https://coronavirus.jhu.edu/), using the datasets provided at https://github.com/CSSEGISandData/COVID-19.
...
tribble(
  ~State, ~Tested, 
  "New South Wales", 56941, 
  "Queensland", 32394,
  "Victoria", 23700,
  "Western Australia", 140 + 9948,
  "South Australia", 17100,
  "Tasmania", 807,
  "Australian Capital Territory", 32 + 2576
) %>%
  left_join(
    latestAU, 
