...
# States Within Australia {.tabset}
...
lm %>%
  ...
  pander(
    ...
    caption = paste(
      ...
      "with no states appearing to show a daily", 
      "confirmed infection rate which is increasing at a different rate than in NSW.",
      "However, the TAS confirmed infection rate appears to be increasing at a slower rate than the rest of the country.",
...
All results are valid at the time of report generation, however these numbers may lag actual testing numbers by 24-48 hours.
