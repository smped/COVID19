...
Australian values are updated periodically throughout the day using values provided by https://api.infotorch.org/api/covid19/totals/.
...
# Update the AU figures if there are any updates
...
Testing numbers were manually sourced from https://covid-19-au.github.io/, then updated with any changes indicated at https://api.infotorch.org/api/covid19/totals/.
The number of tested individuals in each state was then assessed as a function of State population size.
All results are valid at the time of report generation, however these numbers are dependent on media releases and may lag actual testing numbers by 24-48 hours.
