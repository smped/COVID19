...
recovered <- url("https://raw.githubusercontent.com/ulklc/covid19-timeseries/master/report/raw/rawReport.csv") %>%
  ...
  mutate(
    Country = str_replace_all(
      # Set South Korea to match the previous format
